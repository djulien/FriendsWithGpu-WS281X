...
//wrap with non-inline function for easier debug:
 non_inline void init_final(void)
 {
	ONPAGE(LEAST_PAGE); //put code where it will fit with no page selects
	init(); //prev init
 }
 #undef init
 #define init()  init_final() //function chain in lieu of static init
#endif //def init


#ifdef debug
//wrap with non-inline function for easier debug:
 non_inline void debug_final(void)
 {
	ONPAGE(LEAST_PAGE); //put code where it will fit with no page selects
	debug(); //prev debug
 }
 #undef debug
 #define debug()  /*if (NEVER)*/ debug_final() //function chain in lieu of expr eval in compiler #warning/#error/#pragma messages
#endif //def init


#ifdef on_tmr_dim
//wrap with non-inline function for easier debug:
 non_inline void on_tmr_dim_final(void)
 {
	ONPAGE(LEAST_PAGE); //put code where it will fit with no page selects
 ...
 #undef on_tmr_dim
 #define on_tmr_dim()  on_tmr_dim_final() //function chain
#endif //def on_tmr_dim


#ifdef on_tmr_50msec
//wrap with non-inline function for easier debug:
 non_inline void on_tmr_50msec_final(void)
 {
	ONPAGE(LEAST_PAGE); //put code where it will fit with no page selects
 ...
 #undef on_tmr_50msec
 #define on_tmr_50msec()  on_tmr_50msec_final() //function chain
#endif //def on_tmr_50msec


#ifdef on_tmr_1sec
//wrap with non-inline function for easier debug:
 non_inline void on_tmr_1sec_final(void)
 {
	ONPAGE(LEAST_PAGE); //put code where it will fit with no page selects
 ...
 #undef on_tmr_1sec
 #define on_tmr_1sec()  on_tmr_1sec_final() //function chain
#endif //def on_tmr_1sec


#ifdef on_rx
//wrap with non-inline function for easier debug:
 non_inline void on_rx_final(void)
 {
	ONPAGE(LEAST_PAGE); //put code where it will fit with no page selects
 ...
 #undef on_rx
 #define on_rx()  on_rx_final() //function chain
#endif //def on_rx


#ifdef on_zc_rise
//wrap with non-inline function for easier debug:
 non_inline void on_zc_rise_final(void)
 {
	ONPAGE(LEAST_PAGE); //put code where it will fit with no page selects
 ...
 #undef on_zc_rise
 #define on_zc_rise()  on_zc_rise_final() //function chain
#endif //def on_zc_rise


#ifdef on_zc_fall
//wrap with non-inline function for easier debug:
 non_inline void on_zc_fall_final(void)
 {
	ONPAGE(LEAST_PAGE); //put code where it will fit with no page selects
 ...
 #undef on_zc_fall
 #define on_zc_fall()  on_zc_fall_final() //function chain
